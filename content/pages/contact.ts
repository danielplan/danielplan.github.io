const content = {
  meta: {
    ...
    keywords:
      'contact, daniel plan, daniel plan web development, daniel plan photography, daniel plan design, daniel plan contact',
    image: '/img/meta/general.png',
  },
  titleSmall: "Let's get in",
  titleBig: 'touch',
  description: 'Here are some ways to _contact me._',
  contactOptions: [
    {
      label: 'Instagram',
      icon: 'instagram.svg',
